...
"""autogenerated by genpy from action_demo/numberActionResult.msg. Do not edit."""
import codecs
import sys
...
class numberActionResult(genpy.Message):
  _md5sum = "980fcd6cd3b52f85f724060fe5067462"
  _type = "action_demo/numberActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_demo/numberResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(numberActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_demo.msg.numberResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_demo.msg.numberResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.not_used,) = _get_struct_I().unpack(str[start:end])
      return self
