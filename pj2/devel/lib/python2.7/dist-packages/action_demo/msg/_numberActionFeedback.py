...
"""autogenerated by genpy from action_demo/numberActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class numberActionFeedback(genpy.Message):
  _md5sum = "1fcc7b473c65a1f63e5742645b9b4eae"
  _type = "action_demo/numberActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_demo/numberFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(numberActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = action_demo.msg.numberFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_demo.msg.numberFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.server_current_number
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.server_current_number,) = _get_struct_I().unpack(str[start:end])
      return self
